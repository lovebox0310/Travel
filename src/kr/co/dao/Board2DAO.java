...
public class Board2DAO {
	...
	public void insert(Board2DTO dto, Board2FileDTO fdto) {
		Connection conn = null;
		PreparedStatement pstmt = null;
	...
	public Board2FileDTO readF(int num) {
		Board2FileDTO dto = null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		...
		try {
			...
			if (rs.next()) {
				...
				dto = new Board2FileDTO(-1, fName, ogFName, url);
	...
	public void update(Board2DTO dto, Board2FileDTO fdto) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		PreparedStatement pstmt2 = null;
	...
	public void reply(int orgnum, Board2DTO dto, Board2FileDTO fdto) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		PreparedStatement pstmt2 = null;
		String sql = "insert into board2 (num, writer, title, content, location, repRoot, repStep, repIndent) "
