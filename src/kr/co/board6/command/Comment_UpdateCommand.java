...
public class Comment_UpdateCommand implements Command {
	...
	public CommandAction execute(HttpServletRequest request, HttpServletResponse response)
		...
		Board6CommentDTO cDto = new Board6CommentDTO(comment_num, comment_board, comment_content, comment_writer, null, -1, -1, -1);
