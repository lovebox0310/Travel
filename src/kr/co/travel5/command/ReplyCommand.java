...
public class ReplyCommand implements Command {
	...
	public CommandAction execute(HttpServletRequest request, HttpServletResponse response)
		...
		int num = -1;
		if(fileName!=null) {
		num = dao.reply(orgnum, new Board5DTO(-1, writer, locationID, null, title, content, null,  -1, -1, -1, -1, -1),
				new Board5FileDTO(fileName, orgFileName, realPath));
		}else {
		num = dao.reply(orgnum, new Board5DTO(-1, writer, locationID, null, title, content, null, 0, -1, -1, -1, -1), null);
		}
