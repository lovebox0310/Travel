...
public class UpdateCommand implements Command {
	...
	public CommandAction execute(HttpServletRequest request, HttpServletResponse response)
		...
		if(fileName!=null) {
		 dao.update(new Board5DTO(num, writer, locationID, null, title, content, null, 0, 0, 0, 0, -1),
				new Board5FileDTO(fileName, orgFileName, realPath));
		}else {
			dao.update(new Board5DTO(num, writer, locationID, null, title, content, null, 0, 0, 0, 0, -1), null);
		}
