...
<body>
	...
	<div class="container" style="margin: 30px auto 30px auto;">
		...
		<form action="board7ask.do" method="post" class="was-validated" enctype="multipart/form-data">
			...
			<a class="btn btn-secondary" href="board7qnalist.do?id=${param.id}">뒤로가기</a>
		</form>
