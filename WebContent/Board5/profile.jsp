...
<body>
	...
	<div class="container">
		<form action="Board5profileupdateui.do">
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">
									...
									<div class="tab-content ml-1" id="myTabContent">
										<div class="tab-pane fade show active" id="basicInfo" role="tabpanel" aria-labelledby="basicInfo-tab">
											...
											<div class="row">
												...
												<div class="col-md-8 col-6">${memberDTO.name }</div>
											</div>
											<hr />
											...
											<div class="row">
												...
												<div class="col-md-8 col-6">${memberDTO.age}</div>
											</div>
											<hr />
											<div class="row">
												<div class="col-sm-3 col-md-2 col-5">
			...
			<a onclick="alert('돌아올 수 없는 강을 건너시겠습니까?');" class="btn btn-outline-primary float-right" href="Board5profiledelete.do">탈퇴</a>
